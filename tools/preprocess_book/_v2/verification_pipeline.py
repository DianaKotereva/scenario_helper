...
from tools.preprocess_book._v2.candidate_selector import CandidateSelector, normalize_text
from tools.preprocess_book._v2.cluster_manager import ClusterManager
from tools.preprocess_book._v2.edge_rewriter import EdgeRewriter
from tools.preprocess_book._v2.io import append_jsonl, load_results
from tools.preprocess_book._v2.llm_judge import LLMJudge
from tools.preprocess_book._v2.models import NodeEvent, RepairCandidate, VerificationDecision
...
class VerificationPipelineV2:
    ...
    def _build_event(self, source_id: Tuple[int, ...], idx: int, raw: dict) -> NodeEvent:
        chapter_id = int(source_id[0]) if source_id else 0
